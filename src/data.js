  ...
  certificates: [
    {
      ...
      slug: "advanced-django-building-a-blog",
      category: "Advanced Django",
      image: "https://i.ibb.co/4425B1G/mdadrf.jpg",
      description:
      ...
      verifyAt: "https://coursera.org/verify/FVH3G5SXFXE9",
    },
    {
      name: "Building Web Applications In Django",
      slug: "building-web-applications-in-django",
      category: "Django",
      image: "https://i.ibb.co/0V5bFs1/bwaid.jpg",
      description:
      ...
      verifyAt: "https://coursera.org/verify/35ZS8Q5DZE66",
    },
    {
      name: "Django Features And Libraries",
      slug: "django-features-and-libraries",
      category: "Django",
      image: "https://i.ibb.co/F76QkkC/dfal.jpg",
      description:
      ...
      verifyAt: "https://coursera.org/verify/N9WJNE98TZPC",
    },
    {
      name: "Using JavaScript, JQuery, And JSON In Django",
      slug: "using-javascript-jquery-and-json-in-django",
      category: "Django",
      image: "https://i.ibb.co/48t8gJZ/ujjajid.jpg",
      description:
      ...
      verifyAt: "https://coursera.org/verify/MFAP548CMSPX",
    },
    {
      name: "Web Application Technologies And Django",
      slug: "web-application-technologies-and-django",
      category: "Django",
      image: "https://i.ibb.co/qj4pYQZ/watad.jpg",
      description:
      ...
      verifyAt: "https://coursera.org/verify/LQWSTVJN6ULX",
    },
    {
      name: "Django For Everybody",
      slug: "django-for-everybody",
      category: "Django",
      image: "https://i.ibb.co/QrrTsDg/dfe.jpg",
      description:
      ...
      verifyAt: "https://coursera.org/verify/specialization/FSH2U69WQS67",
    },
    {
      name: "Foundations Of User Experience (UX) Design",
      slug: "foundations=of-user-experience-(ux)-design",
      category: "Google",
      image: "https://i.ibb.co/NsnWdM3/foued.jpg",
      description:
      ...
      verifyAt: "https://coursera.org/verify/ADMPPCNFMS8Y",
    },
    {
      name: "Introduction To Git And GitHub",
      slug: "introduction-to-git-and-github",
      category: "Google",
      image: "https://i.ibb.co/m4bywGK/itgag.jpg",
      description:
        "In this course, you’ll learn how to keep track of the different versions of your code and configuration files using a popular version control system (VCS) called Git. We'll also go through how to setup an account with a service called GitHub so that you can create your very own remote repositories to store your code and configuration. Throughout this course, you'll learn about Git's core functionality so you can understand how and why it’s used in organizations. We’ll look into both basic and more advanced features, like branches and merging. We'll demonstrate how having a working knowledge of a VCS like Git can be a lifesaver in emergency situations or when debugging. And then we'll explore how to use a VCS to work with others through remote repositories, like the ones provided by GitHub. By the end of this course, you'll be able to store your code's history in Git and collaborate with others in GitHub, where you’ll also start creating your own portfolio!",
      verifyAt: "https://coursera.org/verify/8GQ28F76ZP52",
    },
    {
      name: "Crash Course on Python",
      slug: "crash-course-on-python",
      category: "Python",
      image: "https://i.ibb.co/thRjfMh/Crash-Course-On-Python-2.jpg",
      description:
      ...
      verifyAt: "https://coursera.org/verify/G7C5Y6G6QW3G",
    },
    {
      name: "Java Programming: Arrays, Lists, And Structured Data",
      slug: "arrays-lists-and-structured-data",
      category: "Java",
      image: "https://i.ibb.co/sgRWqVM/alasd.jpg",
      description:
      ...
      verifyAt: "https://coursera.org/verify/NT3J32R4LC66",
    },
    {
      name: "Java Programming: Build a Recommendation System",
      slug: "build-a-recommendation-system",
      category: "Java",
      image: "https://i.ibb.co/KW0vVTV/bars.jpg",
      description:
    ...
    },
    {
      ...
      verifyAt: "https://coursera.org/verify/WLKXDDHBM2CZ",
    },
    {
      name: "Java Programming: Solving Problems with Software",
      slug: "solving-problems-with-software",
      category: "Java",
      image: "https://i.ibb.co/5xn7h9s/spws.jpg",
      description:
      ...
      verifyAt: "https://coursera.org/verify/PG7ZT3DTXQJ7",
    },
    {
      name: "Advanced Styling With Responsive Design",
      slug: "advanced-styling-with-responsive-design",
      category: "Web Design for Everybody",
      image: "https://i.ibb.co/vd1wx4Q/aswrd.jpg",
      description:
      ...
      verifyAt: "https://coursera.org/verify/K66PLASHB4LU",
    },
    {
      name: "Interactivity with JavaScript",
      slug: "interactivity-with-javascript",
      category: "Web Design for Everybody",
      image: "https://i.ibb.co/nmvKfpd/iwj.jpg",
      description:
      ...
      verifyAt: "https://coursera.org/verify/ZGJSSGHUU5Z6",
    },
    {
      name: "Introduction to CSS3",
      slug: "introduction-to-css3",
      category: "Web Design for Everybody",
      image: "https://i.ibb.co/yprT7XW/itc.jpg",
      description:
      ...
      verifyAt: "https://coursera.org/verify/DPWJ88EX6HF7",
    },
    {
      name: "Introduction to HTML5",
      slug: "introduction-to-html5",
      category: "Web Design for Everybody",
      image: "https://i.ibb.co/R0q3Pj4/ith.jpg",
      description:
        "Thanks to a growing number of software programs, it seems as if anyone can make a webpage. But what if you actually want to understand how the page was created? There are great textbooks and online resources for learning web design, but most of those resources require some background knowledge. This course is designed to help the novice who wants to gain confidence and knowledge. We will explore the theory (what actually happens when you click on a link on a webpage?), the practical (what do I need to know to make my own page?), and the overlooked (I have a page, what do I do now?). Throughout the course there will be a strong emphasis on adhering to syntactic standards for validation and semantic standards to promote wide accessibility for users with disabilities.  The textbook we use is available online, “The Missing Link: An Introduction to Web Development and Programming” by Michael Mendez from www.opensuny.org. This course will appeal to a wide variety of people, but specifically those who would like a step-by-step description of the basics. There are no prerequisites for this course and it is assumed that students have no prior programming skills or IT experience. The course will culminate in a small final project that will require the completion of a very simple page with links and images. The focus of this course is on the basics, not appearance. You can see a sample final page at http://intro-webdesign.com/html5-plain.html. This is the first course in the Web Design For Everybody specialization. Subsequent courses focus on the marketable skills of styling the page with CSS3, adding interactivity with JavaScript and enhancing the styling with responsive design. You can see a sample site for the capstone course at http://intro-webdesign.com/",
      verifyAt: "https://coursera.org/verify/PURKFX2RMSTY",
    },
  ],
};
export default data;
